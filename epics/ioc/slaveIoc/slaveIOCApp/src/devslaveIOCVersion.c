...
#include "slaveIOCVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = slaveIOCVERSION;
...
static lsidset devslaveIOCVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devslaveIOCVersion);
