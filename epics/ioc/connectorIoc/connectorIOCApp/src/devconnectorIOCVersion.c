...
#include "connectorIOCVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = connectorIOCVERSION;
...
static lsidset devconnectorIOCVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devconnectorIOCVersion);
